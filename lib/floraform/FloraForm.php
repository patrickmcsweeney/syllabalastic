...
abstract class FloraForm_Component
{
	...
	{
		if( !isset($this->id) ) { return ""; }
		if( !empty($this->options["id-prefix"]) ) { return $this->options["id-prefix"]."_".$this->id; }
		return $this->id;
	}
...
class FloraForm_Field_Textarea extends FloraForm_Field
{
	...
	function renderInput( $defaults=array() )
	{
		...
		$html .= " class='ff_input_textarea'>".htmlspecialchars($default)."</textarea>";
